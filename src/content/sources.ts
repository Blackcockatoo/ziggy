...
export const sources: Source[] = [
  ...
  {
    id: "shop-ledger",
    label: "Awaiting shop archive confirmation",
    publisher: "Primary source sought: Rob / Carla",
    kind: "shop-record",
    note: "Not yet sighted. The single most valuable outstanding source for this project.",
  },
  {
    id: "interview-rob",
    label: "To be confirmed with Rob",
    publisher: "Primary source sought: Rob",
    kind: "interview",
    note: "Not yet recorded. Required before any first-person quotation is published.",
  },
  {
    id: "interview-carla",
    label: "To be confirmed with Carla",
    publisher: "Primary source sought: Carla",
    kind: "interview",
    note: "Not yet recorded. Carla's preferred credit and role must come from her, not from inference.",
  },
  {
    id: "local-press-monkey",
    label: "Archive slot — local press source pending",
    publisher: "Frankston local press (publication unconfirmed)",
    kind: "press",
